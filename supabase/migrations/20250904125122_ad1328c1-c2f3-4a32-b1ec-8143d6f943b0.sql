-- Calendar events and participants tables - creating tables first
...
-- 7) Helpful indexes
CREATE INDEX idx_calendar_events_organizer_start ON public.calendar_events (organizer_id, start_at);
